...
<ul>
  ...
  <li class="m2"><span><mono>scale_edge_width()</mono> and similar functions can be used to adapt edges or nodes.</span></li><br>
</ul>
...
<ul>
  <li class="m1"><span><mono>group_louvain()</mono> and similar functions can be used to determine node groups (clusters).</span></li><br>
</ul>
