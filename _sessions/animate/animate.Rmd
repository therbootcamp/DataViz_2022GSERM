...
p = ggplotly(p, width = 600, height=700)
p
```
...
p = ggplotly(p, width = 500, height=600)
p
```
...
p = ggplotly(p, width = 500, height=600, tooltip = "text")
...
<h1><font style="font-size:12px">click to download</font><br><a href="https://www.dropbox.com/s/eoabrgz52rj87cu/Animate.Rmd?dl=1">Practical</a></h1>
