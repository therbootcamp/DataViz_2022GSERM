...
>### The goal of this workshop is to introduce you to R's tools for data visualization and communication and how they can use to effectively communicate insights from data!
...
<ul>
  <li class="m1"><span>Core of the workshop consists of 7 sessions on R, consisting of.</span></li>
  <ul class="level">
...
<h1><a href="">Download<br>project</a></h1>
