...
<ul>
  <li class="m1"><span>HTML gets interpreted in RStudio (or browsers) so that a well-formated document emerges.</span></li>
...
<ul>
  ...
  <li class="m2"><span>Inline code can include any type/length of code.</span></li>
</ul>
